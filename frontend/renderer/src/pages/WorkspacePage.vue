    ...
    <section class="transcript-panel">
      <header class="panel-header">
        ...
        <button
          ...
          @click="meetingsStore.runTranscription"
        >
          {{
            meetingsStore.transcribing
              ? i18n.t("transcribingMedia")
              : i18n.t("runTranscription")
          }}
        </button>
      </header>

      <section class="transcript-scroll-area">
        <WorkflowStepper
          :export-count="meetingsStore.exports.length"
          :exporting="Boolean(meetingsStore.exportingFormat)"
          :generating-note="meetingsStore.generatingNote"
          :has-note="meetingsStore.hasSavedNote"
          :importing="meetingsStore.importing"
          :latest-task="latestTask"
          :meeting="currentMeeting"
          :note-dirty="meetingsStore.noteDirty"
          :transcribing="meetingsStore.transcribing"
          :transcript-count="segments.length"
        />
